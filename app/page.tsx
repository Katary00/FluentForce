        ...
        >
            ...
            >
              <div className="text-center mb-6">
                <div
                  ...
                  role="banner"
                >
                  <Sparkles className="w-5 h-5 text-purple-800 dark:text-purple-300" role="presentation" />
                  <span className="text-sm font-semibold text-purple-800 dark:text-purple-300">
                    What Makes Us Unique
                  </span>
                </div>
            ...
            >
              <div className="text-center">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-6">
                  ...
                  >
                    <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full flex items-center justify-center" role="presentation">
                  ...
                  >
                    <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center" role="presentation">
                  ...
                  >
                    <div className="w-8 h-8 bg-gradient-to-r from-red-500 to-red-600 rounded-full flex items-center justify-center" role="presentation">
                  ...
                  >
                    <div className="w-8 h-8 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center" role="presentation">
                  ...
                  >
                    <div className="w-8 h-8 bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-full flex items-center justify-center" role="presentation">
                ...
                >
                  <div className="flex -space-x-2">
                    <div className="w-8 h-8 bg-gradient-to-r from-purple-400 to-purple-500 rounded-full border-2 border-white dark:border-gray-800" role="presentation"></div>
                    <div className="w-8 h-8 bg-gradient-to-r from-blue-400 to-blue-500 rounded-full border-2 border-white dark:border-gray-800" role="presentation"></div>
                    <div className="w-8 h-8 bg-gradient-to-r from-green-400 to-green-500 rounded-full border-2 border-white dark:border-gray-800" role="presentation"></div>
                    <div className="w-8 h-8 bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-full border-2 border-white dark:border-gray-800 flex items-center justify-center" role="presentation">
                ...
                <div className="p-6">
                  <div className="text-center">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
                      ...
                      >
                        <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full flex items-center justify-center mb-2 shadow-lg" role="presentation">
                      ...
                      >
                        <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center mb-2 shadow-lg" role="presentation">
                      ...
                      >
                        <div className="w-12 h-12 bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-full flex items-center justify-center mb-2 shadow-lg" role="presentation">
                      ...
                      >
                        <div className="w-12 h-12 bg-gradient-to-r from-teal-500 to-teal-600 rounded-full flex items-center justify-center mb-2 shadow-lg" role="presentation">
                      ...
                      >
                        <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center mb-2 shadow-lg" role="presentation">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                <CardHeader className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-4" role="presentation">
              ...
              >
                <CardHeader className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-red-500 to-red-600 rounded-full flex items-center justify-center mx-auto mb-4" role="presentation">
